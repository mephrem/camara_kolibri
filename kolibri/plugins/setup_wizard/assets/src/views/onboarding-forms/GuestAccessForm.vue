...
<script>
  ...
  export default {
    ...
    $trs: {
      description:
        'This allows anyone to view resources on Camara Learning Studio without needing to make an account',
      header: 'Enable guest access?',
      noOptionLabel: 'No. Users must have an account to view resources on Camara Learning Studio',
    },
  };
